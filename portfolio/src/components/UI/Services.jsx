      ...
      <div className="container lg:pt-5">
        <div className="text-center">
          ...
          <p className="lg:max-w-[600px] lg:mx-auto text-headingColor font-[500] text-[16px] leading-7">
            ...
            nemo quos, tempore ut voluptates dignissimos odio corrupti vel ex
            dolores nam assumenda consectetur fugiat perferendis laudantium
            asperiores ratione, ad autem.
          </p>
        </div>
                    ...
                    <div className="w-full sm:w-1/2 sm:pr-8">
                      ...
                      >
                        ...
                        <p className="text-[15px]   text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7">
                          ...
                          elit. Distinctio vero tempora blanditiis tempore nihil
                          harum!
                        </p>
                      </div>
                    </div>
